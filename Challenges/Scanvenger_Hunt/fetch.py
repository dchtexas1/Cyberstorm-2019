...
mode = 1  # 0 - 7 bits, ignore files with any 1's in first 3; 1 - 10-bits, concatenate
ftp_address = '138.47.148.167'
port = 8008
dir_location = "/.lookee-here/now-in-here"

ftp_username = 'spartans'
ftp_password = 'spartansSPARTANSspartans'
